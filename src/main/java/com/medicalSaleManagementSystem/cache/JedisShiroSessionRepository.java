package com.medicalSaleManagementSystem.cache;

import com.medicalSaleManagementSystem.session.CustomSessionManager;
import com.medicalSaleManagementSystem.session.SessionStatus;
import com.medicalSaleManagementSystem.session.ShiroSessionRepository;
import com.medicalSaleManagementSystem.util.LoggerUtils;
import com.medicalSaleManagementSystem.util.SerializeUtil;
...
public class JedisShiroSessionRepository implements ShiroSessionRepository {
    public static final String REDIS_SHIRO_SESSION = "jluZh-teaching-assistance-system-shiro-session:";
    //这里有个小BUG，因为Redis使用序列化后，Key反序列化回来发现前面有一段乱码，解决的办法是存储缓存不序列化
    public static final String REDIS_SHIRO_ALL = "*jluZh-teaching-assistance-system-shiro-session:*";
